...
var rainbowColors = ['blue', 'green', 'indigo', 'orange', 'red', 'violet', 'yellow']
...
var firstHeroArr = heroes.splice(0,1);
var firstHero = firstHeroArr[0];
console.log(heroes);
...
var secondHeroArr = heroes.slice(2, 1);
var secondHero = secondHeroArr[0];


// leave batman in the array but put a copy of him on a variable called thirdHero
var thirdHeroArr = heroes.slice(1,1);
var thridHero = thirdHeroArr[0];
